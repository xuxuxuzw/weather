<?php
namespace Xuxuxuzw\Weather\Tests;

use GuzzleHttp\Client;
use GuzzleHttp\ClientInterface;
use GuzzleHttp\Psr7\Response;
use Mockery\Matcher\AnyArgs;
use Xuxuxuzw\Weather\Exceptions\HttpException;
use Xuxuxuzw\Weather\Exceptions\InvalidArgumentException;
use Xuxuxuzw\Weather\Weather;
...
// json
    ...
    {
        $w = new Weather('1a70a3e4690e4eb95adc1b4949e59e51');
